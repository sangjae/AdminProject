package com.example.user.adminproject;
...
import com.example.user.adminproject.login.AdminLogin;
...
public class Intro extends AppCompatActivity{
    ...
    Runnable mrun = new Runnable(){
        @Override
        public void run(){
            Intent i = new Intent(Intro.this, AdminLogin.class); //인텐트 생성(현 액티비티, 새로 실행할 액티비티)
            startActivity(i);
            finish();
